...
public class BlokusLocalGame extends LocalGame {
    ...
    protected boolean makeMove(GameAction action) {
        ...
        if(action instanceof BlokusSelectAction) {
           ...
           state.calcLegalMoves(state.getBoard(), playerId);state.checkLegals(state.getBoard(), playerId, state.getBlockArray()[playerId][state.getSelectedType()]);
           return true;
        }
            ...
            state.calcLegalMoves(state.getBoard(), playerId);
